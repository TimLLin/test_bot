...
def start_answer(a):
    if a.data == 'schedule':
        ...
        bot.send_message(a.message.chat.id, 'Код написали:\nЖуравлёв Алексей и Калимуллин Тимур\n\nНаучный руководитель:\nФархиева Светлана Анатольевна', reply_markup=markup_reply6)
